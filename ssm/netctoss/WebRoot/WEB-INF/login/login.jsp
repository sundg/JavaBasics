...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
    	...
    	<script type="text/javascript" src="/netctoss/js/prototype-1.6.0.3.js"></script>
        ...
        <form method="post" action="login.do">
            <table>
                ...
                <tr>
                    ...
                    <td><img src="/netctoss/login/valicode.do" onclick="this.src='/netctoss/login/valicode.do?f='+new Date().getTime()" alt="验证码" title="点击更换" /></td>  
